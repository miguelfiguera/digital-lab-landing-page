      ...
      <div className="container grid items-center justify-center gap-4 px-4 md:px-6">
        <div className="space-y-3">
          ...
          <p className="mx-auto max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
            We take a strategic and data-driven approach to digital marketing,
        ...
        <div className="mx-auto w-full max-w-5xl grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          <div className="flex flex-col items-start gap-2">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              We collaborate with you to develop innovative and eye-catching
              digital campaigns.
            </p>
          </div>
          <div className="flex flex-col items-start gap-2">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Our team works quickly and efficiently to bring your campaigns to
              life.
            </p>
          </div>
          <div className="flex flex-col items-start gap-2">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              We continuously analyze and optimize your campaigns to maximize
              their impact.
            </p>
          </div>
        </div>
